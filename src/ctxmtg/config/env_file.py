...
Reads and writes the ~/.ctxmtg/.env file for persisting per-role
LLM API configuration.  The file uses standard KEY=VALUE format
compatible with pydantic-settings env_file loading.
